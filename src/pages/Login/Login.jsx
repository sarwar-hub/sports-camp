            ...
            <div className="max-w-md mx-auto bg-dark p-10">
                ...
                <div>
                    <div className="flex flex-col ">
                        ...
                        <button onClick={handleGoogleLogin} className="bg-dark2 px-4 py-2 text-light font-semibold border-[1px] border-light hover:bg-dark2/50">Continue with Google</button>
                    </div>
                </div>
            </div>
        </div>
